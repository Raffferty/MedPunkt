...
public class old_UserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.old_activity_user);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fabAddDiseases:
                Intent intent = new Intent(old_UserActivity.this, WhenAndWhatDieseasActivity.class);
